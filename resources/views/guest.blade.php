            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="{{ url('/') }}" active>Dashboard</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link disabled" href="#">Create Your Shortern Link</a>
                    </li>
                    </ul>

                    @if (Route::has('login'))
                        @auth
                            <a class="user-access" href="{{ url('/dashboard') }}" class="">Dashboard</a>
                        @else
                           <a class="user-access login" href="{{ route('login') }}" class=""><strong>Log in</strong></a>

                            @if (Route::has('register'))
                                <a class="user-access" href="{{ route('register') }}" class=""><strong>Register</strong></a>
                            @endif
                        @endauth
                        @endif
